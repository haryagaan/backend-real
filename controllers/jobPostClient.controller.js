...
exports.writeCommentClient=async(req,res)=>{
...
exports.getCommentsClient=async(req,res)=>{
    const postId=req.params.post
    ...
    try{
        ...
        const postSocial=await JobPostClient.findById(postId).populate({path:"comments" , populate:{path:"creatorSocialId"}});

        const postBasic=await JobPostClient.findById(postId).populate({path:"comments" , populate:{path:"creatorId"}});
